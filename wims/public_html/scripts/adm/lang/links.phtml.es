...
Diversos enlaces a su $name_classe:<ul>
 <li>El enlace
  ...
  le lleva a la página de mantenimiento $name_classesss (preparación de hojas de trabajo, lista de los participantes y de sus progresos, etc.). 
 <p></li>
 <li>El enlace
 ...
 <li>Finalmente, el enlace
  ...
  lleva a los estudiantes inscritos a la página inicial $name_classesss. Las hojas de trabajo que prepare les serán accesibles desde esta página de inicio.
 <p></li>
</ul>
<p><span class="wims_warning">Importante</span>. 
¡Guarde estos enlaces antes de salir de esta página!
<p>
También le aconsejamos que anote el número de la clase : <tt>$code</tt>.
