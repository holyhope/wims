...
symbol_table_create(int length)
{
	...
	static char    *functions_names[] = {
		"ln", "exp", "log", "sqrt", "sin", "cos", "tan", "cot", "sec",
	...
	math_ln, exp, log, sqrt, sin, cos, tan, math_cot, math_sec, math_csc, asin, acos, atan, math_acot, math_asec, math_acsc, sinh, cosh, tanh, math_coth, math_sech, math_csch, math_asinh, math_acosh, math_atanh, math_acoth, math_asech, math_acsch, fabs, math_step, math_delta, math_nandelta, erf};	/* Symbol 
																																				 * table 
																																				 * predefined 
																																				 * functions 
																																				 * pointers 
