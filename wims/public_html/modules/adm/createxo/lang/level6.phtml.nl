!set name_subtitle = Binaire Bestanden voor oefeningen
!set name_over_quota = Er is helaas voor niet genoeg ruimte meer beschikbaar.

!set name_add_file = Add a new file
!set name_add_file_label = Het bestand voor deze oefening:
!set name_add_file_help = U kunt diverse bestandstypes opsturen (plaatjes , audio, pdf, ...)

!set name_empty_imglist = Deze oefening bevat geen binaire bestanden.
!set name_imglist = Hier staat de lijst van verwerkte bestanden
!set name_filename = Bestandsnaam
...
!set name_how_to_hide_help = <h2>Hiding Images files names</h2>\
    ...
    <p>Due to its performance cost, this method should be used only when necessary.</p>\
