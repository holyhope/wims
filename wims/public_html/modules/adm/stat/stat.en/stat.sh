...
tmpfile=$w_wims_home/$w_wims_sesdir/stat
modstatfile=$w_wims_home/bin/modstat
cd $w_wims_home/log/account
...
access=`awk 'BEGIN {a=0;b=0;c=0}; \
	$1 >= '$start' && $1 <= '$end' {a=a+$2;b=b+$3;c=c+$4}; \
	END {print a" "b" "c}' $w_stat_module`
