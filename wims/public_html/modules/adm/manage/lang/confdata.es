...
<dl>
<dt><span class="tt">all</span><dd>Every one can create classes.
<dt><span class="tt">deny</span><dd>Nobody is allowed to create classes.
...
developper.
<p>
It is highly recommended that you choose <span class="tt">close</span>, in order
