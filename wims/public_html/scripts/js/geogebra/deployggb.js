...
/** Original deployggb.js file, modified tu use internal hosted version of Geogebra, instead of downloading it from geogebra CDN **/

// Hack WIMS 1 : replace the original "getTubeURL" geogebra function.
var getTubeURL = function() {
    return "scripts/js/geogebra/geogebraweb/";
};

/** See "readme.md" to see other modifications to be done to an ggb upgrade. **/
