...
!default good_answer_text=Correcte antwoord
!default bad_answer_text=Verkeerde antwoord
!default incomplete_answer_text=Incompleet antwoord

!default aucune=geen van allen

!set explication= verschillende soorten meerkeuze vragen\
    Goed/Fout\
    vul de blanko velden in\
