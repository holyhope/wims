...
:linksh
<h2 id="general">lier un document à une feuille d'exercices</h2>

<p>Vous pouvez choisir de lier votre document à une feuille d'exercices précise contenant les mêmes séries d'exercices que ceux présent dans le document. Cela permet d'obtenir un enregistrement du travail effectué par les élèves lorsqu'ils cliquent sur les liens d'exercices du document. 
</p>
<p>Vous pouvez créer la feuille d'exercices vous même ou utiliser le lien de génération automatique. 
</p>
!exit

:autogenerate
<h2 id="statut">Génération automatique de la feuille d'exercices d'un document</h2>
