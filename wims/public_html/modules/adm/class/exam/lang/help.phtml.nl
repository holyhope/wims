...
faudra avoir terminé les $stries essais avant $h_fin :
<ul><li>
Si vous avez pris $d_1 min pour faire le 1er essai et que vous commencez
votre second essai à $h_3, vous disposerez de $sdure min pour faire l'examen
au 2ème essai.
</li><li>
...
Vous pouvez voir le résultat des essais précédents
 en cliquant sur
...
l'élève voit la feuille d'examen, mais n'a accès qu'au titre des exercices,
