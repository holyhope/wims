...
// Data source functions for DynLayer
DynLayer.prototype._getDSValue = function(){return this.getHTML()};
DynLayer.prototype._setDSValue = function(d){
	this.setHTML(d);
};
DynLayer.prototype.getDataSource = DataSource._GetDataSource;
DynLayer.prototype.setDataSource = function(ds,field){
