...
!set name_sorry=!nosubst Afligido, la carga a distancia de la nueva versión de Wims a partir de <span class="tt"> $download</span> ha fallado. Intente más tarde, por favor.
